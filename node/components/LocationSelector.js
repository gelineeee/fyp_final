...
const style = {
  wrapper: `pt-0 h-full`,
  searchHeader: `w-full font-bold text-left flex items-center text-3xl p-4 pt-7 overflow-hidden`,
...
const LocationSelector = () => {
  ...
  const { pickup, setPickup, dropoff, setDropoff } = useRido();

  return (
    <div className={style.wrapper}>
      <div className={style.searchHeader}>
        {inFocus === "from" ? "Pick up at?" : "Where to?"}
      </div>
